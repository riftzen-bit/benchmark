...
-- Real, shipped model IDs only. Source: vendor model cards / API references.
insert into public.models (id, vendor, family, released_at, context_k, visible) values
  ...
  ('gpt-5',                           'openai',    'gpt',       '2025-08-07',  400, true),
  ...
  -- Google Gemini
  ('gemini-3-pro',                    'google',    'gemini',    '2025-11-18', 1000, true),
